...
// ---------- 7 段指南模板（单一来源：project-guide-skill/guide-template.md——可移植 skill 包） ----------
const GUIDE_TEMPLATE = readFileSync(
  path.join(import.meta.dirname, "..", "..", "project-guide-skill", "guide-template.md"),
  "utf8"
).split("---\n\n【材料】")[0].trim();
