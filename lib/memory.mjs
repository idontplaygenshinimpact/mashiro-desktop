...
import { similarityRule } from "./similarity.mjs"; // 相似度引擎统一工单：薄弱点合并/讲解复用统一走引擎
...
// 判据已收编到 lib/similarity.mjs（相似度引擎统一工单）——isSimilarWeakTopic 委托 similarityRule(weak)
/**
...
// 已收编到 lib/similarity.mjs（strict 严格度：结构词/变体词/泛词/2-gram 0.6 集中）——
