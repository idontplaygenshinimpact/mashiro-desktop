 ...
 * @param {{maxTokens?: number, temperature?: number, timeout?: number}} [opts]
 */
async function chat(messages, { maxTokens = 4000, temperature = 0.4, timeout = undefined } = {}) {
  const data = await llmChat(messages, { maxTokens, temperature, ...(timeout ? { timeout } : {}) });
