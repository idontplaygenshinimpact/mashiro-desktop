...
export async function generateQuiz(card) {
  ...
  try {
    ...
    const prompt = `你是${prof.roleLabel}。为知识点「${card.topic}」出 ${BATCH_SIZE} 道单选题，用于复习自测（快速回忆，不是面试提问）。
题目素材（复习卡）：
