...
// RAG/Agent 相关 4 组（RAG与LLM/RAG/Agent/Agent/LLM）合并为兜底规则组名"RAG与LLM"
const GROUP_ALIAS = { "RAG": "RAG与LLM", "Agent": "RAG与LLM", "Agent/LLM": "RAG与LLM", "LLM": "RAG与LLM", "AI Agent": "RAG与LLM" };
