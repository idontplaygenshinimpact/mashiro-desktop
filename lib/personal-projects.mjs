    ...
    try {
      ...
      if (fullSummary.length > 500) {
        ...
        try {
          ...
          // 八股段：从 subagent 汇总里提取【八股清单】后的内容
          const baIdx = fullSummary.indexOf("【八股清单】");
          const baSection = baIdx >= 0 ? fullSummary.slice(baIdx) : "（subagent 未输出八股清单——见源码要点）";
