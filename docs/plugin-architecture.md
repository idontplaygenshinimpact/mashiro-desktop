...
| CI | GitHub Actions：单测全量 + Windows 构建验证 | 1033+ 测试作为门禁（截至 2026-09-04 实测），开源后贡献者代码必须过 CI |
...
- 1033 测试护航，全绿即完成（截至 2026-09-04 实测）
...
| 风险 | 对策 |
|---|---|
| 迁移回归 | 1033 测试（含 28 个 jsdom 面板交互）作门禁，阶段验收全绿才前进 |
